...
const {
  chai, chaiHttp, app, sinon, dropDatabase, AuthStrategies, ObjectID, crypto, faker, AuthenticationModule, jwt, OperationsHelper,
} = require('../../../testHelper');
...
describe('Authorization', async () => {
  ...
  describe('social sign in', async () => {
    ...
    it('should not authorize without token', async () => {
      const result = await chai.request(app).post('/auth/facebook').send({ userName });
