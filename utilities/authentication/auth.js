...
exports.socialAuth = async( { userName, socialName, provider, avatar, id, postLocales } ) => {
    ...
    if( !userBySocial && userName ) {
        ...
        return await signUpSocial( { userName, socialName, avatar, provider, id, session, postLocales } );
    }
